        ...
        return (
            <div className="menu-box">
                ...
                <div className="menu-box-center">
                    <div onClick={() => this.setState({ activeButton: 0 })} className="menu-button">
                        <div className={this.state.activeButton == 0 ? buttonActive : buttonInactive}>
                            Character
                        </div>
                    </div>
                    <div onClick={() => this.setState({ activeButton: 1 })} className="menu-button">
                        <div className={this.state.activeButton == 1 ? buttonActive : buttonInactive}>
                            Skills
                        </div>
                    </div>
                    <div onClick={() => this.setState({ activeButton: 2 })} className="menu-button">
                        <div className={this.state.activeButton == 2 ? buttonActive : buttonInactive}>
                            Combat
                        </div>
                    </div>
                    <div onClick={() => this.setState({ activeButton: 3 })} className="menu-button">
                        <div className={this.state.activeButton == 3 ? buttonActive : buttonInactive}>
                            Inventory
                        </div>
                    </div>
                    <div onClick={() => this.setState({ activeButton: 4 })} className="menu-button">
                        <div className={this.state.activeButton == 4 ? buttonActive : buttonInactive}>
                            Notes
                        </div>
                    </div>
                    <div onClick={() => this.setState({ activeButton: 5 })} className="menu-button">
